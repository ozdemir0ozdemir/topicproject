...
public class ExampleDataCreator {
	...
	CommandLineRunner runner(TopicManager topics) {
		return args -> {
			...
			topicList.add(
					"Sed eget sapien id ligula auctor suscipit at laoreet erat Sed eget sapien id ligula auctor suscipit at laoreet erat");
			topicList.add(
					"Sed eget sapien id ligula auctor suscipit at laoreet erat Sed eget sapien id ligula auctor suscipit at laoreet erat Sed eget sapien id ligula auctor suscipit at laoreet erat");
			topicList.add(
					"Sed eget sapien id ligula auctor suscipit at laoreet erat Sed eget sapien id ligula auctor suscipit at laoreet erat Sed eget sapien id ligula auctor suscipit at laoreet erat Sed eget sapien id ligula auctor suscipit at laoreet erat");
